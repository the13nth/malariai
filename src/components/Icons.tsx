...
export function MicroscopeIcon({ className = "h-5 w-5" }: IconProps) {
  return (
...
export function TargetIcon({ className = "h-5 w-5" }: IconProps) {
  return (
    <svg className={className} fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
      <path strokeLinecap="round" strokeLinejoin="round" d="M4.5 12a7.5 7.5 0 1115 0 7.5 7.5 0 01-15 0zm0 0A2.25 2.25 0 006.75 9.75 2.25 2.25 0 019 12M4.5 12a2.25 2.25 0 012.25 2.25A2.25 2.25 0 019 12m3-6.75V3m0 18.75V21m-2.25-9h-3.375m13.5 0h-3.375m-3.375 0h3.375M12 9.75V12m0 2.25V15" />
    </svg>
  );
}
