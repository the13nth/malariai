...
const objectives = [
  { number: "01", text: "Develop and validate an AI model achieving <strong>&ge;90% sensitivity</strong> and <strong>&ge;80% specificity</strong> in malaria parasite detection." },
  { number: "02", text: "Create a <strong>user-friendly diagnostic interface</strong> accessible to healthcare workers with minimal training." },
  { number: "03", text: "<strong>Reduce diagnostic time</strong> from 15&ndash;30 minutes to under 10 minutes per sample." },
];
...
const deploymentOptions = [
  {
    title: "Cloud-Based",
    desc: "Centralized processing with internet-connected microscopy stations. Enables real-time data aggregation for surveillance and continuous model improvement.",
  },
  {
    title: "Edge Computing",
    desc: "On-device inference for offline environments with limited or no internet connectivity. Results are stored locally and synced when connectivity is available.",
  },
];
        ...
        <div className="mx-auto max-w-6xl px-4 sm:px-6">
          ...
          <div className="mt-10 space-y-4">
            {objectives.map((obj) => (
              <div
                key={obj.number}
                className="group cursor-pointer rounded-xl border border-zinc-200 bg-white p-5 shadow-sm transition-all duration-200 hover:border-primary/20 hover:shadow-md"
              >
          ...
          <div className="mt-10 space-y-3">
            {references.map(([name, url]) => (
              <a
                ...
                className="group flex cursor-pointer items-center gap-3 rounded-xl border border-zinc-200 bg-white px-5 py-4 text-sm text-body shadow-sm transition-all duration-200 hover:border-primary/30 hover:bg-accent hover:shadow-md"
              >
                <svg
