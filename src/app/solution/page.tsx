...
const validationItems = [
  { title: "Cross-Validation", desc: "K-fold cross-validation on training data ensures model robustness and detects overfitting early in development." },
  { title: "External Validation", desc: "Testing on independent datasets from different geographical regions evaluates generalization across populations." },
  { title: "Clinical Trials", desc: "Prospective studies comparing AI diagnosis with expert microscopy and RDTs measure real-world clinical performance." },
  { title: "Regulatory Compliance", desc: "Adherence to medical device regulations ensures the system meets safety and efficacy requirements." },
];
        ...
        <div className="mx-auto max-w-6xl px-4 sm:px-6">
          ...
          <div className="mt-10 space-y-4">
            {dataSteps.map((step) => (
              <div
                key={step.number}
                className="group cursor-pointer rounded-xl border border-zinc-200 bg-white p-6 shadow-sm transition-all duration-200 hover:border-primary/20 hover:shadow-md"
              >
